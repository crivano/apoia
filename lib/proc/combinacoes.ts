...
const padroesPeticaoInicialEContestacao = [
    [ANY(), EXACT(T.PETICAO_INICIAL), ANY({ capture: [T.EMENDA_DA_INICIAL, T.CONTESTACAO, T.INFORMACAO_EM_MANDADO_DE_SEGURANCA, T.LAUDO, T.LAUDO_PERICIA] }), OR(T.CONTESTACAO, T.INFORMACAO_EM_MANDADO_DE_SEGURANCA), ANY()],
    [ANY(), EXACT(T.PETICAO_INICIAL), ANY({ capture: [T.EMENDA_DA_INICIAL, T.CONTESTACAO, T.INFORMACAO_EM_MANDADO_DE_SEGURANCA, T.LAUDO, T.LAUDO_PERICIA, T.CONTESTACAO, T.INFORMACAO_EM_MANDADO_DE_SEGURANCA] })],
]

const padroesBasicos = [
    ...padroesApelacao,
    [ANY(), EXACT(T.SENTENCA), ANY(), OR(T.APELACAO, T.RECURSO, T.RECURSO_INOMINADO), ANY()],
    [ANY(), EXACT(T.PETICAO_INICIAL), ANY({ capture: [T.EMENDA_DA_INICIAL, T.CONTESTACAO, T.INFORMACAO_EM_MANDADO_DE_SEGURANCA, T.LAUDO, T.LAUDO_PERICIA] }), OR(T.CONTESTACAO, T.INFORMACAO_EM_MANDADO_DE_SEGURANCA), ANY(), EXACT(T.SENTENCA), ANY()],
