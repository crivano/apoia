...
import relatorio_completo from '@/prompts/relatorio-completo.md'
...
export const internalPrompts = {
    ...
    relatorio_completo: promptDefinitionFromMarkdown('relatorio_completo', relatorio_completo),
    relatorio: promptDefinitionFromMarkdown('relatorio', relatorio),
}
