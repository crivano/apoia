...
export default function PromptForm(props) {
    ...
    if (!initialState.testset_id) initialState.testset_id = props.testsets && props.testsets[0] ? props.testsets[0].id : null
    ...
    return (
        <div className="row mb-5">
            ...
            <Frm.Select label="Coleção de Testes Padrão" name="testset_id" options={props.testsets} width={4} />
            ...
            <div className='col col-12'>
                ...
                {tab === 'fields'
                    ? (<>
                        <Frm.TextArea label="JSON Schema (opcional)" name="content.json_schema" />
                        <Frm.TextArea label="Format (opcional)" name="content.format" />
                        <Frm.TextArea label="Prompt de Sistema (opcional)" name="content.system_prompt" />
                        <Frm.TextArea label="Prompt" name="content.prompt" />
                    </>)
            ...
            <div className="col col-auto mt-3 mb-3">
                ...
                <Button variant="primary" disabled={pending || _.isEqual(data, initialState)} className="me-3" onClick={handleSave}>Salvar</Button>
            ...
            {testset && <><h2>Testes</h2>
                <TestPage testset={testset} overrideSystemPrompt={data.content.system_prompt} overridePrompt={data.content.prompt} overrideJsonSchema={data.content.json_schema} overrideFormat={data.content.format} />
            </>}
