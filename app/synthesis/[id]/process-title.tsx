...
export default async function ProcessTitle(params) {
    ...
    //                 Processo {id}
    //                 {process.env.NAVIGATE_TO_PROCESS_URL && (<>&nbsp;<a href={process.env.NAVIGATE_TO_PROCESS_URL.replace('{numero}', id)} className="text-white" type="submit"><FontAwesomeIcon icon={faUpRightFromSquare} /></a></>)}
    //             </div>
    //         </Container>
    //     </Navbar >
    // )
